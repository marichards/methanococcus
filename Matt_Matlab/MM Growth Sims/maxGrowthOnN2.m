function solution = maxGrowthOnN2(model)
...
%Turn off NH3 input and turn on N2
model = changeRxnBounds(model,'EX_cpd00013_e0',0,'l');
model = changeRxnBounds(model,'EX_cpd00528_c0',-10,'l');
...
[~,n2_idx] = intersect(model.rxns,'EX_cpd00528_c0');
