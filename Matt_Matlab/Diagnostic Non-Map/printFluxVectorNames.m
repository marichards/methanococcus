function printFluxVectorNames(model,fluxData,nonZeroFlag,excFlag,sortCol,fileName,headerRow,formulaFlag)
...
if (excFlag)
    ...
    labels = model.rxnNames(selExchange);
    fluxData = fluxData(selExchange,:);
else
    labels = model.rxnNames;
end
