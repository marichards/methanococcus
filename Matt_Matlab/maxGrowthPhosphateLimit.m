function solution = maxGrowthPhosphateLimit(model)
...
%Turn down Phosphate to -0.01 so it limits
model = changeRxnBounds(model,'EX_cpd00009_e0',-0.01,'l');
...
%Find the reaction indices, including phosphate and ammonia
