...
% rxn: an essential reversible reaction that prevents model growth when
% constrained to be irreversible
%
% OUTPUT
% fixRxns: a list of reactions that are currently irreversible in the model
% but, when turned reversible, allow for growth when the supplied reaction
% is constrained to be irreversible
%
